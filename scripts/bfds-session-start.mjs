...
硬阶段边界：
- CONTEXT_BLOCKED：父会话逐题询问用户项目级 Impeccable init 信息。用 answer --stage init 记录多轮回答和确认；确认前不写 PRODUCT.md 或 DESIGN.md。PRODUCT.md 是战略上下文；DESIGN.md 是 Stitch 视觉设计系统文档，不是架构文档。
